      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br />
            I am currently employed as an Intern software developer at ICEP.
            <br />
          ...
          <ul>
            <li className="about-activity">
              <ImPointRight /> Playing and watching soccer
            </li>
            <li className="about-activity">
          ...
          <footer className="blockquote-footer">LUNGA</footer>
        </blockquote>
      </Card.Body>
    </Card>
  );
